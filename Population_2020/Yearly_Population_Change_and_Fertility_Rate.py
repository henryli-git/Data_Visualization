...
plt.title("Yearly Population Change and Fertility Rate for the 50 Most Populous Countries", fontsize=18, fontweight='bold', color='#045F86')
plt.xlabel('Yearly Population Change (%)', fontsize=15, fontweight='bold', color='#045F86')
...
plt.savefig('Yearly_Population_Change_and_Fertility_Rate_graph.png', ppi=300)
plt.show()
